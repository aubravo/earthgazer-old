...
class Location:
    def __init__(self, name: str, latitude: float, longitude: float, description: Optional[str] = '',
                 monitoring_start: Optional[str] = '1990-01-01', monitoring_end: Optional[str] = '2050-01-01'):
        self.name = name
    ...
    @property
    def as_dict(self):
        return {'location_name': self.name,
